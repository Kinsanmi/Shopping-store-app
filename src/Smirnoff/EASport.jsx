...
import { EaSport, KnorrCube, PortableImg, PortableSales } from '../Data/Products/Product';
...
export const EASport = ({handleAddProduct, to,label, notificationMessage}) => {
  ...
  return (
    ...
    <main className="clear-page">
        ...
        <Link to='/store'>Home<MdOutlineKeyboardArrowRight /></Link>
            ...
            <Link to='/store'>PlayStation 5<MdOutlineKeyboardArrowRight /></Link>
            <Link to='/store'>PS5 Games<MdOutlineKeyboardArrowRight /></Link> <span>FC 24 Playstation 5</span>
        </div>
        ...
        <div className="portable">
            <div className="portable-content">
                <div className="portable-img">
                    {EaSport.map((item, index)=>{
                        ...
                        <div className="port-img">
                            <img src={item.image} alt="product_image_name-EA Sports-FC 24 Playstation 5-1" />
                        ...
                        <div className="port-desc">
                            <div className="drink">
                                <div className="drink-can">
                                    <div className="drink-text">EA Sports FC 24 Playstation 5<span className="heart"><FaRegHeart className='heart-icon' /></span></div>
                                    <div className="product">Brand: <Link>EA Sport</Link> | <Link>Similar products from EA Sport</Link></div>
                                </div>
                            </div>
                ...
                <div id='/product/detail' className="portable-detail">
                    ...
                    <div className="detail">EA Sports FC 24 marks the beginning of the future of football. Built on innovation and authenticity, feel closer to the game in the most true-to-football experience yet with the best players from the biggest clubs, leagues, and competitions around the globe. <div className="more-detail">
                    ...
                    With more than 19,000 fully licensed players, 700 teams, and 30 leagues, including the UEFA Men’s and Women’s Champions League, EA Sports FC 24 brings unrivaled authenticity to the pitch.
                    </div>
                    ...
                    <div className="more-detail">
                    Explore the three new technologies—HyperMotionV, PlayStyles, and the enhanced Frostbite Engine—that power EA Sports FC 24.
                    </div>
                    
                    <div className="more-detail">
                    Ultimate Team, Career experiences and more. Dive into fan favorite Ultimate Team and explore all that MyCAREER, clubs, and Volta Football have to offer.
                    </div>

                    <div className="more-detail">
                    Earn FC Founder Status
                    </div>

                    <div className="more-detail">
                    Play EA Sports FC™ 24 by November 1, 2023, and become an FC Founder. Earn a Founder badge and kit in addition to Founder-only benefits throughout EA Sports FC 24 and beyond.
                    </div>
                            ...
                            <div className="spec-features">
                                <div className="features">
                                    ...
                                    <div className="markup">
                                        <ul>
                                            <li>EA Sports FC 24 is the next chapter in a more innovative future of football.</li>
                                            <li>The revolutionized Frostbite Engine delivers The World’s Game in lifelike detail, bringing a new level of immersion to each match.</li>
                                            <li>19,000+ fully licensed players, 700+ teams, and 30+ leagues playing together in the most authentic football experience ever created.</li>
                                            <li>Feel closer to the game with three cutting-edge technologies powering unparalleled realism in every match.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div className="spec-detail">
                                <div className="spec-item">
                                    ...
                                    <div className="spec-list">
                                        <ul>
                                            <li><span>SKU</span>: EA839EC41UTMVNAFAMZ</li>   
