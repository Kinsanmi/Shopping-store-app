          ...
          <div className="portable-content">
                      ...
                      <div className="drink">
                        <div className="drink-can">
                          <div className="drink-text">
                            Malta Guinness Can 330 x24
                            <span className="heart">
                              <FaRegHeart className="heart-icon" />
                            </span>
                          </div>
                          <div className="product">
                            Brand: <Link>Malta Guinness</Link> |{" "}
                            <Link>Similar products from Malta Guinness</Link>
                          </div>
                        </div>
                      </div>
            ...
            <div id="/product/detail" className="portable-detail">
              ...
              <div className="detail">
                Non alcoholic premium soft drink. Full of vitalizing goodness,
                with added vitamins, minerals and slow burning sugars for longer
                lasting energy that fuels your greatness...
                {showMore && (
                  <>
                    <div className="more-detail">
                      <img
                        ...
                        alt="product_image_name-Malta Guinness-Can 330ml x24-1"
                      />
                      Malta Guinness is Africa’s leading non-alcoholic, adult,
                      premium soft drink, produced by Diageo. It was launched in
                      Cameroon in 1984. Today Malta Guinness is a hugely
                      successful and profitable brand.
                    </div>
                    <div className="more-detail">
                      Malta Guinness is brewed with only the finest ingredients;
                      Sucrose, Maize, Sorghum, Barley, Malt extract, Sorghum
                      Malt, Caramel, Hops, water, several vitamins & minerals,
                      etc. It remains the favourite Malt drink in Nigeria for
                    ...
                    <div className="more-detail">
                      <ul>
                        <li>
                          It is a non alcoholic, adult, premium soft drink.
                        </li>
                        <li>
                          It is wholesome nourishment from the finest natural
                          ingredients
                        </li>
                        <li>
                          Full of vitalizing goodness, with added vitamins,
                          minerals and slow burning sugars for longer lasting
                          energy.
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="more-detail">
                      Malta Guinness Classic is the Nation’s No. 1 favorite malt
                      dink. The “bustling” brand which is filled with Goodness,
                      Energy, and Vitality is positioned to fuel the CAN-DO
                      spirit of Nigerians. Both Malta Guinness Classic and Malta
                      Guinness Herbs lite variants are premium malt offerings.
                    </div>
                  </>
                )}
                    ...
                    <div className="features">
                      ...
                      <div className="markup">
                        <ul>
                          ...
                          <li>
                            Malta Guinness Classic is the Nation’s No. 1
                            favorite malt dink.
                          </li>
                          <li>24 cans</li>
                          <li>330ml</li>
                  ...
                  <div className="spec-detail">
                    <div className="spec-item">
                      ...
                      <div className="spec-list">
                        <ul>
                          <li>
                            <span>SKU</span>: GU341GR1LIQXYNAFAMZ
                          </li>
                          <li>
