    ...
    <>
      <main className="clear-page">
        <div className="link_page">
          ...
          <span>Dry Comfort Roll-on For Women, 72 - -50ml (Pack Of 3)</span>
        </div>
          ...
          <div className="portable-content">
                    ...
                    <div className="port-desc">
                      <div className="drink">
                        <div className="drink-can">
                          <div className="drink-text">
                            NIVEA Dry Comfort Roll-on For Women, 72h- 50ml (Pack
                            Of 3)
                      ...
                      <div className="shield">
                        ...
                        <Link className="extra">
                          Need extra money? Loan up to N500,000 on the E-Shop
                          pay Android app.
                        </Link>
                      </div>
                      <div className="shield">
            ...
            <div id="/product/detail" className="portable-detail">
              ...
              <div className="detail">
                <strong>NIVEA</strong> Dry Comfort anti-perspirant deodorant
                offers you powerful protection tested in real life situations.
                NIVEA Dry Comfort combines 48 hours reliable protection against
                sweat and body odour with gentle care for your underarm skin.
                The spirit of white and dry, care and freshness: wrapped in
                clean citrus, fresh accents of dry linen and sheer powdery
                inflexions, this fragrance is the best friend of women who need
                reassurance and care. Place your order for this amazing product
                from E-Shop Nigeria and have it delivered to your doorstep at an
                amazing price
                <div className="more-detail">
                  KEY PRODUCT FEATURES
                  <ul>
                    <li>
                      Effective regulation pf perspiration - with Dry-Plus
                      System and minerals
                    </li>
                    <li>
                ...
                <div className="more-detail">
                  Water, Aluminum Chlorohydrate, PPG-15 Stearyl Ether,
                  Steareth-2, Steareth-21, Parfum, Aluminum Sesquichlorohydrate,
                  Magnesium Aluminum Silicate, Persea Gratissima Oil, Trisodium
                  EDTA, BHT, Linalool, Limonene, Benzyl Alcohol, Alpha-Isomethyl
                  Ionone, Citronellol, Geraniol, Benzyl Salicylate
                </div>
              </div>
            </div>
                  ...
                  <div className="spec-features">
                    <div className="features">
                      ...
                      <div className="markup">
                        <ul>
                          <li>
                            Effective regulation of perspiration - with Dry-Plus
                            System and minerals
                          </li>
                          <li>
                            48h anti-perspirant protection and gentle NIVEA®
                            care
                          </li>
                  ...
                  <div className="spec-detail">
                    <div className="spec-item">
                      ...
                      <div className="spec-list">
                        <ul>
                          <li>
                            <span>SKU</span>: NI930ST2Q7I1GNAFAMZ
                          </li>
                          <li>
                            <span>Weight(kg)</span>: 1
                          </li>
                        </ul>
                      </div>
                    </div>
