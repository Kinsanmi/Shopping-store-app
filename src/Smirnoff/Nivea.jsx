...
import {  NiveaDry, NiveaImg } from '../Data/Products/Product';
...
export const Nivea = ({handleAddProduct, to,label ,notificationMessage}) => {
    ...
    const [sliderData, setSliderData] = useState(NiveaImg[0])

    const handleImage = (index)=>{
        const slider = NiveaImg[index]
  ...
  return (
    ...
    <main className="clear-page">
        ...
        <Link to='/store'>Home<MdOutlineKeyboardArrowRight /></Link>
            ...
            <Link to='/store'>Deodorants & Antiperspirants<MdOutlineKeyboardArrowRight /></Link> <span>Dry Comfort Roll-on For Women, 72 - -50ml (Pack Of 3)</span>
        </div>

        <div className="portable">
            <div className="portable-content">
                <div className="portable-img">
                    {NiveaDry.map((item, index)=>{
                        return (
                        ...
                        <div className="port-desc">
                            <div className="drink">
                                <div className="drink-can">
                                    <div className="drink-text">NIVEA Dry Comfort Roll-on For Women, 72h- 50ml (Pack Of 3)<span className="heart"><FaRegHeart className='heart-icon' /></span></div>
                            ...
                            <div className="shipping">
                                ...
                                <div className="rating-star">
                                    ...
                                    <Link className='verify'>(327 verified ratings)</Link>
                                </div>
                            </div>
                ...
                <div id='/product/detail' className="portable-detail">
                    ...
                    <div className="detail"><strong>NIVEA</strong> Dry Comfort anti-perspirant deodorant offers you powerful protection tested in real life situations. NIVEA Dry Comfort combines 48 hours reliable protection against sweat and body odour with gentle care for your underarm skin. The spirit of white and dry, care and freshness: wrapped in clean citrus, fresh accents of dry linen and sheer powdery inflexions, this fragrance is the best friend of women who need reassurance and care. Place your order for this amazing product from Jumia Nigeria and have it delivered to your doorstep at an amazing price

                    <div className="more-detail">
                        KEY PRODUCT FEATURES
                        <ul>
                            <li>Effective regulation pf perspiration - with Dry-Plus System and minerals</li>
                            <li>48h anti-perspirant protection and gentle NIVEA® care</li>
                            <li>Skin tolerance dermatological proven</li>
                            <li>Contains no alcohol or colourants</li>
                        </ul>
                    </div>


                    <div className="more-detail">
                    Water, Aluminum Chlorohydrate, PPG-15 Stearyl Ether, Steareth-2, Steareth-21, Parfum, Aluminum Sesquichlorohydrate, Magnesium Aluminum Silicate, Persea Gratissima Oil, Trisodium EDTA, BHT, Linalool, Limonene, Benzyl Alcohol, Alpha-Isomethyl Ionone, Citronellol, Geraniol, Benzyl Salicylate
                    </div>
                    </div>
                </div>
                            ...
                            <div className="spec-features">
                                <div className="features">
                                    ...
                                    <div className="markup">
                                        <ul>
                                            <li>Effective regulation of perspiration - with Dry-Plus System and minerals</li>
                                            <li>48h anti-perspirant protection and gentle NIVEA® care</li>
                                            <li>Skin tolerance dermatologically proven</li>
                                            <li>Without alcohol or colorants</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div className="spec-detail">
                                <div className="spec-item">
                                    ...
                                    <div className="spec-list">
                                        <ul>
                                            <li><span>SKU</span>: NI930ST2Q7I1GNAFAMZ</li>   
