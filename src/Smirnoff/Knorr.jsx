    ...
    <>
      <main className="clear-page">
        <div className="link_page">
          ...
          <span>Chicken Seasoning Cubes 8g x 45</span>
        </div>
          ...
          <div className="portable-content">
                ...
                return (
                  <div key={index} className="port-context">
                    <div className="port-img">
                      <img
                        src={item.image}
                        alt="product_image_name-Knorr-Chicken Seasoning Cubes 8g x 45-1"
                      />
                      ...
                      <div className="drink">
                        <div className="drink-can">
                          ...
                          <div className="product">
                            Brand: <Link>Knorr</Link> |{" "}
                            <Link>Similar products from Knorr</Link>
                          </div>
                        </div>
                      </div>
            ...
            <div id="/product/detail" className="portable-detail">
              ...
              <div className="detail">
                Made with real chicken, the Knorr Chicken Cube is an ideal
                addition to any dish.{" "}
                <div className="more-detail">
                  Want perfectly seasoned, golden-brown chicken? Knorr Chicken
                  Stock Cubes are made with a carefully selected blend of herbs,
                  seasonings and chicken that delicately enhance the natural
                  flavors of your dish.
                </div>
                <div className="more-detail">
                  Turn simple dinner ideas into scrumptious family meals by
                  simply adding Knorr seasoning cubes to your dish. Compliment
                  chicken recipes or use the Knorr Chicken Cubes to add
                  scrumptious flavour and aroma to your rice, stew and spaghetti
                  dishes. You’ll have your friends and family searching for the
                  chicken!
                </div>
                <div className="more-detail">
                  You are guaranteed to make your family smile from ear to ear
                  every time.
                </div>
              </div>
                  ...
                  <div className="spec-features">
                    <div className="features">
                      ...
                      <div className="markup">
                        <ul>
                          <li>
                            Knorr Chicken Seasoning Cubes enhances meals with
                            amazing real chicken flavor
                          </li>
                          <li>
                            Made with a carefully selected blend of herbs,
                            seasonings and meat
                          </li>
                          <li>
                            Fortified with Iron for improved nutrition and which
                            is essential mineral for red blood cells production
                          </li>
                  ...
                  <div className="spec-detail">
                    <div className="spec-item">
                      ...
                      <div className="spec-list">
                        <ul>
                          <li>
                            <span>SKU</span>: KN679FF158J79NAFAMZ
                          </li>
                          <li>
