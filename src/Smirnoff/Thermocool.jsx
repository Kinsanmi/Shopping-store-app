...
import { HaierThermocool, HaierThermocoolImg } from '../Data/Products/Product';
...
import max from '../Data/Image Product/zkedfBx.jpg';
import max1 from '../Data/Image Product/0W6vih3.jpg';




export const Thermocool = ({handleAddProduct, to,label ,notificationMessage}) => {
    ...
    const [sliderData, setSliderData] = useState(HaierThermocoolImg[0])

    const handleImage = (index)=>{
        const slider = HaierThermocoolImg[index]
  ...
  return (
    ...
    <main className="clear-page">
        ...
        <Link to='/store'>Home<MdOutlineKeyboardArrowRight /></Link>
            <Link to='/store'>Home & Office<MdOutlineKeyboardArrowRight /></Link>
            <Link to='/store'>Large Appliance & Home Improvement Care<MdOutlineKeyboardArrowRight /></Link>
            <Link to='/store'>Large Appliance<MdOutlineKeyboardArrowRight /></Link>
            <Link to='/store'>Freezer<MdOutlineKeyboardArrowRight /></Link>
            <Link to='/store'>Deep Freezers<MdOutlineKeyboardArrowRight /></Link><span>146 Litres Chest Freezer (HTF-150) - Silver + 3 Years Warranty</span>
        </div>

        <div className="portable">
            <div className="portable-content">
                <div className="portable-img">
                    {HaierThermocool.map((item, index)=>{
                        return (
                        <div key={index} className="port-context">
                        <div className="port-img">
                            <img src={sliderData.value} alt="product_image_name-Haier Thermocool-146 Litres Chest Freezer (HTF-150) - Silver + 3 Years Warranty-1" />

                            <div className="port-image">
                                {HaierThermocoolImg.map((item, i)=>{
                                    return (
                                        <img className={sliderData.id===i ? 'border' : ''} key={item.id} src={item.value} alt='product_image_name-Haier Thermocool-146 Litres Chest Freezer (HTF-150) - Silver + 3 Years Warranty-1' onClick={()=> handleImage(i)} />
                                    )
                                })}
                            </div>
                        ...
                        <div className="port-desc">
                            <div className="drink">
                                <div className="drink-can">
                                    <div className="drink-text">Haier Thermocool 146 Litres Chest Freezer (HTF-150) - Silver<span className="heart"><FaRegHeart className='heart-icon' /></span></div>
                                    <div className="product">Brand: <Link>Haier Thermocool</Link> | <Link>Similar products from Haier Thermocool</Link></div>
                                </div>
                            </div>
                            ...
                            <div className="shipping">
                                <div className="ship-fee"><span>+</span> shipping from <strong>₦ 2,730</strong> to LEKKI-AJAH (SANGOTEDO)</div>
                                <div className="rating-star">
                                    <div className="rating">
                                    <IoMdStar /><IoMdStar /><IoMdStar /><IoMdStar /><IoMdStarHalf />
                                    </div>
                                    <Link className='verify'>(66 verified ratings)</Link>
                                </div>
                            </div>
                ...
                <div id='/product/detail' className="portable-detail">
                    ...
                    <div className="detail">This Haier Thermocool Chest Freezer has a low noise operation that helps maintain a quieter environment. It also comes with one detachable basket compartment to store vegetables, fruits, and another foodstuff.
                    <div className="detail-img">
                        <img src={max} alt="Haier Thermocool" />
                        <img src={max1} alt="Haier Thermocool" />
                    </div>
                    </div>
                </div>
                            ...
                            <div className="spec-features">
                                <div className="features">
                                    ...
                                    <div className="markup">
                                        <ul>
                                            <li>150 Liters capacity (146 liters Storage Volume)</li>
                                            <li>Dimension (W*D*H) - 720*520*845</li>
                                            <li>Super Freezing</li>
                                            <li>Anti-rust protected</li>
                                            <li>LED light</li>
                                            <li>Safety door lock</li>
                                            <li>Low noise operation</li>
                                            <li>75mm insulation thickness</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div className="spec-detail">
                                <div className="spec-item">
                                    ...
                                    <div className="spec-list">
                                        <ul>
                                            <li><span>SKU</span>: HA992HA29FP4LNAFAMZ</li>    
                                            <li><span>Model</span>: SML - 150</li>   
                                            <li><span>Weight(kg)</span>: 85</li>   
                                            <li><span>Weight(kg)</span>: 85</li>   
