    ...
    <>
      <main className="clear-page">
        <div className="link_page">
          ...
          <Link to="/store">
            Large Appliance & Home Improvement Care
            <MdOutlineKeyboardArrowRight />
          </Link>
          <Link to="/store">
            Large Appliance
          ...
          <span>
            146 Litres Chest Freezer (HTF-150) - Silver + 3 Years Warranty
          </span>
        </div>
          ...
          <div className="portable-content">
                  ...
                  <div key={index} className="port-context">
                    <div className="port-img">
                      <img
                        ...
                        alt="product_image_name-Haier Thermocool-146 Litres Chest Freezer (HTF-150) - Silver + 3 Years Warranty-1"
                      />
                    ...
                    <div className="port-desc">
                      <div className="drink">
                        <div className="drink-can">
                          <div className="drink-text">
                            Haier Thermocool 146 Litres Chest Freezer (HTF-150)
                            - Silver
                          ...
                          <div className="product">
                            Brand: <Link>Haier Thermocool</Link> |{" "}
                            <Link>Similar products from Haier Thermocool</Link>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="shipping">
                        <div className="ship-fee">
                          <span>+</span> shipping from <strong>₦ 2,730</strong>{" "}
            ...
            <div id="/product/detail" className="portable-detail">
              ...
              <div className="detail">
                This Haier Thermocool Chest Freezer has a low noise operation
                that helps maintain a quieter environment. It also comes with
                one detachable basket compartment to store vegetables, fruits,
                  ...
                  <div className="spec-features">
                    <div className="features">
                      ...
                      <div className="markup">
                        <ul>
                          <li>
                            150 Liters capacity (146 liters Storage Volume)
                          </li>
                  ...
                  <div className="spec-detail">
                    <div className="spec-item">
                      ...
                      <div className="spec-list">
                        <ul>
                          <li>
                            <span>SKU</span>: HA992HA29FP4LNAFAMZ
                          </li>
                          <li>
                            <span>Model</span>: SML - 150
                          </li>
                          <li>
                            <span>Weight(kg)</span>: 85
                          </li>
                          <li>
                            <span>Weight(kg)</span>: 85
                          </li>
