    ...
    <>
      <main className="clear-page">
        <div className="link_page">
          ...
          <span>
            Bluetooth selfie stick tripod + fill light + shutter remote
          </span>
        </div>
                  ...
                  <div key={index} className="port-context">
                    <div className="port-img">
                      <img
                        ...
                        alt="product_image_name-Generic-Bluetooth Selfie Stick Tripod + Fill Light +Shutter Remote-1"
                      />
                      ...
                      <div className="drink">
                        <div className="drink-can">
                          <div className="drink-text">
                            Bluetooth Selfie Stick Tripod + Fill Light + Shutter
                            Remote
              ...
              <div className="more-detail">
                <div className="spec-list-selfie">
                  <ul>
                    ...
                    <li>
                      1. Long press to turn on the remote control switch. The
                      blue indicator light of the remote control flashes.
                    </li>
                    <li>
                      2. Turn on the phone's Bluetooth, search for new devices,
                      and then connect.
                    </li>
                    <li>
                      3. After the pairing and connection are completed, open
                      the mobile phone camera software.
                    </li>
                    <li>
                      4. For iphone can directly press the shutter of the remote
                      control to take pictures.
                    </li>
                    <li>
                      5. Most Android phones can also directly press the shutter
                      control to take pictures.
                    </li>
                    <li></li>
                    <li></li>
                    ...
                    <li>
                      The light pattern warm light/cold light/cool and warm
                      light 6-speed dimming
                    </li>
                    <li></li>
                    <li></li>
                    <li></li>
                    ...
                    <div className="features">
                      ...
                      <div className="markup">
                        <ul>
                          ...
                          <li>
                            Bluetooth version Bluetooth: 4.0 Bluetooth distance:
                            10M
                          </li>
                          <li>
                            System: Android 4.4 and above/iOS 5.1 and above
                          </li>
                          ...
                          <li>
                            The tripod opens to a maximum height of 1030mm
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div className="spec-detail">
                    <div className="spec-item">
                      ...
                      <div className="spec-list">
                        <ul>
                          <li>
                            <span>SKU</span>:GE779EA1URMDCNAFAMZ
                          </li>
                          <li>
                            <span>Model</span>: N/A
                          </li>
                          <li>
                            <span>Size (L x W x H cm)</span>: 10x8x5
                          </li>
                          <li>
                            <span>Weight (kg)</span>: 0.18
                          </li>
                          <li>
                            <span>Color</span>: BLACK
                          </li>
                          <li>
                            <span>Main Material</span>: PLASTIC+METAL
                          </li>
                          <li>
              ...
              <div className="sell-info">
                <div className="delivery-text">
                  ...
                  <div className="sell-order">
                    <h4>
                      {" "}
                      <IoMdCloseCircle className="poor-rate" />
                      Quality Score: <span>Poor</span>
                    </h4>
                  </div>
                  <div className="sell-order">
                    <h4>
