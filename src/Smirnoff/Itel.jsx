...
export const Itel = ({ handleAddProduct, to, label, notificationMessage }) => {
  ...
  const Timer = () => {
    const nextDay = new Date("May 12, 2023, 10:00:48").getTime();
          ...
          <div className="portable-content">
                      ...
                      <div className="drink">
                        <div className="drink-can">
                          <div className="drink-text">
                            itel 20000mAh Mobile Power Charge Bank
                            <span className="heart">
                              <FaRegHeart className="heart-icon" />
                            </span>
                          </div>
                          <div className="product">
                            Brand: <Link>itel</Link> |{" "}
                            <Link>Similar products from itel</Link>
                          </div>
                        </div>
                      </div>
            ...
            <div id="/product/detail" className="portable-detail">
              ...
              <div className="detail">
                <strong>20000mAh battery</strong> packs not only for portable
                charging but also around the home. Allowing you charge mobile
                devices without having to be tethered to a plug socket. Each of
                them fully charges 4.2 times for Samsung S10, 4 times for iPhone
                11, 2.4 times for iPad mini 5 and 4.6 times for iPhone X.
                <div className="more-detail">
                  Dual Output & Input: Each has 2 USB output ports that detect
                  all the connected devices and efficiently distributes the
                  current output up to 5V 2.1A. The USB C and Micro USB ports
                  can fully refill the battery itself in 10 hrs at 5V 2.0A.
                </div>
                <div className="more-detail">
                  Reliable Li-polymer Cell: Thanks to the Li-polymer battery
                  pack, the charger is much safer than any Li-ion charger. Also,
                  it's light and slimer that you can easily carry it around,
                  even on airplanes.
                </div>
                <div className="more-detail">
                  Handy: It feels incredibly compact for a 20000mAh powerban k,
                  weighing just only 21mm thick. Grippy design is easy to hold,
                  easy to toss into a bag and incredibly portable.
                </div>
                <div className="more-detail">
                  What You Get: Itel 20000mAh USB Portable Charger ; 1 * USB
                  Cable, 1 * 12 Month Warranty 20000mAh High Capacity. It holds
                  enough energy to charge a phone and most tablets for days.
                </div>
                <div className="more-detail">
                  Fast Charging for Two Itel exclusive charging technology
                  ensures up to 2.1A charging speed for two device
                  simultaneously.
                </div>
                <div className="more-detail">
                  Recharge Your Way Choose between Micro USB or Type-C
                  recharging way based on any cable you happen to have on hand.
                </div>
                <div className="more-detail">
                  Anti-Slip Texture The 3D texture is resistant to stains and
                  scratches to keep the elegant look and prevents accidental
                  slips
                </div>
                <div className="more-detail">
                  Superior Safety Surge protection, short circuit prevention and
                  more advanced safety features give you peace of mind.
                </div>
              </div>
            </div>
                  ...
                  <div className="spec-detail">
                    <div className="spec-item">
                      ...
                      <div className="spec-list">
                        <ul>
                          <li>
                            <span>SKU</span>: IT724EA45WDVPNAFAMZ
                          </li>
                          <li>
                            <span>Product Line</span>: itel NG Accessory-COD
                          </li>
                          <li>
                            <span>Model</span>: Star200
                          </li>
                          <li>
                            <span>Size (L x W x H cm)</span>: 16.55 x 8.3 x 2.29
                          </li>
                          <li>
                          ...
                          <li>
                            <span>Main Material</span>: Lithium Battery
                          </li>
                          <li>
