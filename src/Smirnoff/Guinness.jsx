          ...
          <div className="portable-content">
                ...
                return (
                  <div key={index} className="port-context">
                    <div className="port-img">
                      <img
                        src={item.image}
                        alt="product_image_name-Guinness-Smooth Can 33cl x 24-1"
                      />
            ...
            <div id="/product/detail" className="portable-detail">
              ...
              <div className="detail">
                Guinness Smooth is a black full-bodied Irish dry stout with a
                creamy head.
              </div>
                  ...
                  <div className="spec-features">
                    <div className="features">
                      ...
                      <div className="markup">
                        <ul>
                          <li>
                            Medium with pronounced sweetness with a background
                            of roast character
                          </li>
                          <li>
                            A unique and perfect balance of bitter and sweet
                            flavour
                          </li>
                          <li>24 Cans</li>
                  ...
                  <div className="spec-detail">
                    <div className="spec-item">
                      ...
                      <div className="spec-list">
                        <ul>
                          <li>
                            <span>SKU</span>: GU341GR1G5UHYNAFAMZ
                          </li>
                          <li>
