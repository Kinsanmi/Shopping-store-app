...
import max from '../Data/Image Product/24.jpg';
import max1 from '../Data/Image Product/23.jpg';
...
export const Guinness = ({handleAddProduct, to,label, notificationMessage}) => {
  ...
  return (
    ...
    <main className="clear-page">
        ...
        <Link to='/store'>Home<MdOutlineKeyboardArrowRight /></Link>
            ...
            <Link to='/store'>Beers<MdOutlineKeyboardArrowRight /></Link> <span>Smooth Can 33cl x 24 </span>
        </div>

        <div className="portable">
            <div className="portable-content">
                <div className="portable-img">
                    {GuinnessSmooth.map((item, index)=>{
                        return (
                        <div key={index} className="port-context">
                        <div className="port-img">
                            <img src={item.image} alt="product_image_name-Guinness-Smooth Can 33cl x 24-1" />
                        ...
                        <div className="port-desc">
                            <div className="drink">
                                <div className="drink-can">
                                    <div className="drink-text">Guinness Smooth Can 33cl x 24 <span className="heart"><FaRegHeart className='heart-icon' /></span></div>
                            ...
                            <div className="shipping">
                                ...
                                <div className="rating-star">
                                    ...
                                    <Link className='verify'>(45 verified ratings)</Link>
                                </div>
                            </div>
                ...
                <div id='/product/detail' className="portable-detail">
                    ...
                    <div className="detail">Guinness Smooth is a black full-bodied Irish dry stout with a creamy head.</div>
                    <div className="detail-img">
                        <img src={max} alt="Guinness" />
                        <img src={max1} alt="Guinness" />
                    </div>
                </div>
                            ...
                            <div className="spec-features">
                                <div className="features">
                                    ...
                                    <div className="markup">
                                        <ul>
                                            <li>Medium with pronounced sweetness with a background of roast character</li>
                                            <li>A unique and perfect balance of bitter and sweet flavour</li>
                                            <li>24 Cans</li>
                            ...
                            <div className="spec-detail">
                                <div className="spec-item">
                                    ...
                                    <div className="spec-list">
                                        <ul>
                                            <li><span>SKU</span>: GU341GR1G5UHYNAFAMZ</li>   
                                            <li><span>Weight(kg)</span>: 1</li>  
                                            <li><span>Color</span>: N/A</li>  
                                            <li><span>Main Material</span>: N/A</li>  
