    ...
    <>
      <main className="clear-page">
        <div className="link_page">
          ...
          <span>2 IN 1 HAIR STRAIGHTENER AND CURLER </span>
        </div>
                ...
                return (
                  <div key={index} className="port-context">
                    <div className="port-img">
                      <img
                        src={item.image}
                        alt="product_image_name-Nova-2 IN 1 HAIR STRAIGHTENER AND CURLER.-1"
                      />
                      ...
                      <div className="drink">
                        <div className="drink-can">
                          <div className="drink-text">
                            NOVA 2 IN 1 HAIR STRAIGHTENER AND CURLER
                            <span className="heart">
                              <FaRegHeart className="heart-icon" />
                            </span>
                          </div>
                          <div className="product">
                            Brand: <Link>Nova</Link> |{" "}
                            <Link>Similar products from Nova</Link>
                          </div>
                        </div>
                      </div>
            ...
            <div id="/product/detail" className="portable-detail">
              ...
              <div className="detail">
                <div className="more-detail">
                  Nova hair straightener and hair curler gives your natural hair
                  and hair extensions the perfect stretch and curls need. Easy
                  to use, durable and handy for every woman.Nova Professional
                  Hair Straightener comes in a portable size and ergonomic
                  design with rubber handle which makes it comfortable to hold
                  and use. Its compact and lightweight size makes it ideal to
                  take on a trip when you need to fix your hair. It is essential
                  to have at home as it gives your hair a beautiful look in no
                  matter of time. The hair accessory comes with an improvement
                  of thermal efficiency which provides superior heat
                  distribution. The professional hair straightener is ideal for
                  various hair types and come with an easy grip handle that is
                  soft to the handsNova Professional Hair Straightener comes in
                  a portable size and ergonomic design with rubber handle which
                  makes it comfortable to hold and use. Its compact and
                  lightweight size makes it ideal to take on a trip when you
                  need to fix your hair. It is essential to have at home as it
                  gives your hair a beautiful look in no matter of time. The
                  hair accessory comes with an improvement of thermal efficiency
                  which provides superior heat distribution. The professional
                  hair straightener is ideal for various hair types and come
                  with an easy grip handle that is soft to the handsNova
                  Professional Hair Straightener comes in a portable size and
                  ergonomic design with rubber handle which makes it comfortable
                  to hold and use. Its compact and lightweight size makes it
                  ideal to take on a trip when you need to fix your hair. It is
                  essential to have at home as it gives your hair a beautiful
                  look in no matter of time. The hair accessory comes with an
                  improvement of thermal efficiency which provides superior heat
                  distribution. The professional hair straightener is ideal for
                  various hair types and come with an easy grip handle that is
                  soft to the handsFor professional and personal useHair
                  curlerGives the perfect curl and stretchDurable and handyEasy
                  to useDurable Great ValueEasy to handlePower: temperature
                  resistant plastic caseColour Saver Technologyhair dryer comes
                  in different Nova hair straightener and hair curler gives your
                  natural hair and hair extensions the perfect stretch and curls
                  need. Easy to use, durable and handy for every woman.Nova
                  Professional Hair Straightener comes in a portable size and
                  ergonomic design with rubber handle which makes it comfortable
                  to hold and use. Its compact and lightweight size makes it
                  ideal to take on a trip when you need to fix your hair. It is
                  ...
                  curlerGives the perfect curl and stretchDurable and handyEasy
                  to useDurable Great ValueEasy to handlePower: temperature
                  resistant plastic case color Saver Technology
                </div>
              </div>
            </div>
                  ...
                  <div className="spec-features">
                    <div className="features">
                      ...
                      <div className="markup-nova">
                        <ul>
                          <li>
                            For professional and personal useHair curlerGives
                            the perfect curl and stretchDurable and handyEasy to
                            useDurable Great ValueEasy to handlePower:
                            temperature resistant plastic caseColour Saver
                            Technology{" "}
                          </li>
                        </ul>
                      </div>
                  ...
                  <div className="spec-detail">
                    <div className="spec-item">
                      ...
                      <div className="spec-list">
                        <ul>
                          <li>
                            <span>SKU</span>: NO345ST0V0XU3NAFAMZ
                          </li>
                          <li>
                            <span>Product Line</span>: Jeto
                          </li>
                          <li>
                            <span>Model</span>: Universal
                          </li>
                          <li>
                          ...
                          <li>
                            <span>Main Material</span>: ceramic
                          </li>
                        </ul>
                      </div>
                    </div>
              ...
              <div className="sell-info">
                <div className="delivery-text">
                  ...
                  <div className="free-delivery">
                    <h3>Jeto</h3>
                    <h4>
                      <span>86%</span> seller Score
                    </h4>
                    <h4>
                      <span>4060</span> Followers
                    </h4>
                  </div>
