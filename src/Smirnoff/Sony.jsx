  ...
  return (
    ...
    <main className="clear-page">
        ...
        <Link to='/store'>Home<MdOutlineKeyboardArrowRight /></Link>
            <Link to='/store'>Gaming<MdOutlineKeyboardArrowRight /></Link>
            <Link to='/store'>PlayStation<MdOutlineKeyboardArrowRight /></Link>
            <Link to='/store'>PlayStation 4<MdOutlineKeyboardArrowRight /></Link>
            <Link to='/store'>PS4 Consoles<MdOutlineKeyboardArrowRight /></Link> <span>PS4 Slim 500GB Console - Black</span>
        </div>
        ...
        <div className="portable">
            <div className="portable-content">
                <div className="portable-img">
                    {SonyPs4.map((item, index)=>{
                        ...
                        <div className="port-img">
                            <img src={sliderData.value} alt="product_image_name-Sony-PS4 Slim 500GB Console - Black-1" />


                            <div className="port-image">
                                {SonyImg.map((item, i)=>{
                                    return (
                                        <img className={sliderData.id===i ? 'border' : ''} key={item.id} src={item.value} alt='product_image_name-Sony-PS4 Slim 500GB Console - Black-1' onClick={()=> handleImage(i)} />
                                    )
                                })}
                            </div>
                        ...
                        <div className="port-desc">
                            <div className="drink">
                                <div className="drink-can">
                                    <div className="drink-text">Sony PS4 Slim 500GB Console - Black<span className="heart"><FaRegHeart className='heart-icon' /></span></div>
                                    <div className="product">Brand: <Link>Sony</Link> | <Link>Similar products from Sony</Link></div>
                                </div>
                            </div>
                ...
                <div id='/product/detail' className="portable-detail">
                    ...
                    <div className="detail">A Stunning New Design : A slimmer and lighter console with stylish new looks and packed with true PlayStation 4 power. High Dynamic Range (HDR) Technology : Visuals are more realistic, strikingly vivid and truer to what the human eye sees in the real world. Slick Interface : Fast, personal and easier to share, connect and play with friends. Exclusive PS4 Features : Game-changing innovations and ways to keep playing, like Remote Play and Share Play. More Connections : Features 2.4GHz/5GHz Wi-Fi mode options and HDMI 2.0 output.The PS4 system focuses on the gamer, ensuring that the very best games and the most immersive experiences are possible on the platform. The PS4 system enables the greatest game developers in the world to unlock their creativity and push the boundaries of play through a system that is tuned specifically to their needs. The end result is new games with rich, high-fidelity graphics and deeply immersive experiences. Engage in endless personal challenges with your community and share your epic triumphs with the press of a button. Simply hit the SHARE button on the controller, scan through the last few minutes of gameplay, tag it and return to the game—the video uploads as you play. The PS4 system also enhances social spectating by enabling you to broadcast your gameplay in real-time. Remote Play on the PS4 system fully unlocks the PlayStation Vita system’s potential, making it the ultimate companion device. With the PS Vita system, gamers will be able to seamlessly play a range of PS4 titles on the beautiful 5-inch display over Wi-Fi access points in a local area network. Connect to your PS4 system, manage your game downloads, and be ready to game when you walk in the door. The PlayStation App lets you control your PS4 remotely, stay up to date on the games you play, and adds a second-screen experience to hit titles - all from one smooth interface. Now PlayStation goes where you go.
                            ...
                            <div className="spec-features">
                                <div className="features">
                                    ...
                                    <div className="markup">
                                        <ul>
                                        A Stunning New Design : A slimmer and lighter console with stylish new looks and packed with true PlayStation 4 power. High Dynamic Range (HDR) Technology : Visuals are more realistic, strikingly vivid and truer to what the human eye sees in the real world. Slick Interface : Fast, personal and easier to share, connect and play with friends. Exclusive PS4 Features : Game-changing innovations and ways to keep playing, like Remote Play and Share Play. More Connections : Features 2.4GHz/5GHz Wi-Fi mode options and HDMI 2.0 output.The PS4 system focuses on the gamer, ensuring that the very best games and the most immersive experiences are possible on the platform. The PS4 system enables the greatest game developers in the world to unlock their creativity and push the boundaries of play through a system that is tuned specifically to their needs. The end result is new games with rich, high-fidelity graphics and deeply immersive experiences. Engage in endless personal challenges with your community and share your epic triumphs with the press of a button. Simply hit the SHARE button on the controller, scan through the last few minutes of gameplay, tag it and return to the game—the video uploads as you play. The PS4 system also enhances social spectating by enabling you to broadcast your gameplay in real-time. Remote Play on the PS4 system fully unlocks the PlayStation Vita system’s potential, making it the ultimate companion device. With the PS Vita system, gamers will be able to seamlessly play a range of PS4 titles on the beautiful 5-inch display over Wi-Fi access points in a local area network. Connect to your PS4 system, manage your game downloads, and be ready to game when you walk in the door. The PlayStation App lets you control your PS4 remotely, stay up to date on the games you play, and adds a second-screen experience to hit titles - all from one smooth interface. Now PlayStation goes where you go.
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div className="spec-detail">
                                <div className="spec-item">
                                    ...
                                    <div className="spec-list">
                                        <ul>
                                            <li><span>SKU</span>: SO521EL0OVDNLNAFAMZ</li>   
                                            <li><span>Product Line</span>: FIDELITY STORE-1</li>   
                                            <li><span>Weight(kg)</span>: 3</li>   
                                        </ul>
                                    </div>
                                </div>
                ...
                <div className="delivery-content">
                                        ...
                                        <article className='door-delivery'>
                                            ...
                                            <div className='door-detail'>
                                                ...
                                                <div className='delivery-amount'>
                                                    ...
                                                    <div className='amt-ready'>Ready for delivery between <span>04 January</span> & <span>05 January</span> when you order within <span>18hrs 57mins</span></div>
                                                </div>
                                            </div>
                                        </article>
                                    </div>
                                        ...
                                        <article className='door-delivery'>
                                            ...
                                            <div className='door-detail'>
                                                ...
                                                <div className='delivery-amount'>
                                                    ...
                                                    <div className='amt-ready'>Arriving at pickup station between  <span>04 January</span> & <span>05 January</span> when you order within <span>18hrs 57mins</span></div>
                                                </div>
                                            </div>
                                        </article>
                                    </div>
                    ...
                    <div className="sell-info">
                        <div className="delivery-text">
                            ...
                            <div className="sell-order">
                                <h4> <MdStars className='star-rate' />Quality Score: <span>Excellent</span></h4>
                            </div>
                            <div className="sell-order">
                                <h4> <MdStars className='star-rate' />Quality Score: <span>Excellent</span></h4>
                            </div>
