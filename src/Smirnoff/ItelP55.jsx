...
export const ItelP55 = ({
  ...
  const [sliderData, setSliderData] = useState(ItelP55Img[0]);

  const handleImage = (index) => {
    const slider = ItelP55Img[index];
    ...
    <>
      <main className="clear-page">
        <div className="link_page">
          ...
          <span>P55+ 6.6″ HD + Punch Hole Display 128GB ROM + 8GB-GREEN</span>
        </div>

        <div className="portable">
          <div className="portable-content">
            <div className="portable-img">
              {ItelP55Hd.map((item, index) => {
                return (
                    ...
                    <div className="port-desc">
                      <div className="drink">
                        <div className="drink-can">
                          <div className="drink-text">
                            itel P55+ 6.6″ HD + Punch Hole Display 128GB ROM +
                            8GB-GREEN
                      ...
                      <div className="shipping">
                        ...
                        <div className="rating-star">
                          ...
                          <Link className="verify">(1 verified ratings)</Link>
                        </div>
                      </div>
              ...
              <div className="detail">
                <div className="more-detail">
                  <ul>
                    <li>
                      <strong>
                        5000mAh Mega Battery Powers up your whole day.
                      </strong>{" "}
                      Stronger battery with AI Power Master for longer-lasting
                      entertainment and social experience. Always stay online
                      and connected to the world.{" "}
                    </li>
                    <li>
                      <strong>50MP AI Clear Rear Camera</strong> P55+ captures
                      exhilarating moments with a 50MP AI Clear rear camera,
                      delivering crisp and clear image details just like you see
                      in reality.
                    </li>
                    <li>
                      90Hz 6.6'' HD+ Punch Hole Display For an immersive
                      experience 1612×720 Quad High-Definition adding 72% High
                      Color Saturation to restore true colors. Features a 90%
                      screen-to-body ratio that pulls you into the storyline
                      when enjoying movies or shows.
                    </li>
                    <li>
                      256+16 (8+8) GB of Storage Higher efficiency. Faster
                      experience, more space. 256+16GB storage capacity memory
                      fusion for ultra-fast performance and collection of all
                      the fun moments. Switch apps in an instant and enjoy
                    ...
                    <div className="features">
                      ...
                      <div className="markup">
                        <ul>
                          ...
                          <li>45W fast charging always ready to go.</li>
                          <li>256+16 (8+8) GB of Storage Higher efficiency.</li>
                          <li>
                            50MP AI Clear Rear Camera P55+ captures exhilarating
                            moments with a 50MP AI Clear rear camera
                          </li>
                          <li>
                            90Hz 6.6'' HD+ Punch Hole Display For an immersive
                            experience{" "}
                  ...
                  <div className="spec-detail">
                    <div className="spec-item">
                      ...
                      <div className="spec-list">
                        <ul>
                          <li>Smartphone and accessories</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  <div className="spec-detail">
                    <div className="spec-item">
                      ...
                      <div className="spec-list">
                        <ul>
                          <li>
                            <span>SKU</span>: IT724MP42FO75NAFAMZ
                          </li>
                          <li>
                            <span>Product Line</span>: itel NG-COD
                          </li>
                          <li>
                            <span>Model</span>: P55+
                          </li>
