...
export const AceElec = ({handleAddProduct, to,label ,notificationMessage}) => {
  ...
  return (
    ...
    <main className="clear-page">
        ...
        <Link to='/store'>Home<MdOutlineKeyboardArrowRight /></Link>
            <Link to='/store'>phones & Tablets<MdOutlineKeyboardArrowRight /></Link>
            <Link to='/store'>Mobile Phone Accessories<MdOutlineKeyboardArrowRight /></Link>
            <Link to='/store'>Bluetooth Headsets<MdOutlineKeyboardArrowRight /></Link><span>F9 Wireless Fingerprints Touch Bluetooth Headset</span>
        </div>
        ...
        <div className="portable">
            <div className="portable-content">
                        ...
                        <div className="port-desc">
                            <div className="drink">
                                <div className="drink-can">
                                    <div className="drink-text">Ace Elec F9 Wireless Fingerprint Touch Bluetooth Headset<span className="heart"><FaRegHeart className='heart-icon' /></span></div>
                                    <div className="product">Brand: <Link>Ace Elec</Link> | <Link>Similar products from Ace Elec</Link></div>
                                </div>
                            </div>
                            ...
                            <div className="shipping">
                                ...
                                <div className="rating-star">
                                    ...
                                    <Link className='verify'>(2702 verified ratings)</Link>
                                </div>
                            </div>
                ...
                <div id='/product/detail' className="portable-detail">
                    ...
                    <div className="detail">F9-8 <strong>Up-graded</strong> Bluetooth 5.1 Wireless headphones Touch Control with 2000mAh Charging box IPX7 Waterproof of Hifi Stereo Headsets in-ear Built-in Mic Earphones Premium Sound

                    <div className="more-detail">
                        <ul>
                            <li><strong>Balanced,Immersive Sound</strong> : wireless earbuds with the built-in high-quality audio chip，deliver Hi-fi sound quality, achieving the sound of the immersive music scene surround sound.</li>
                            <li>Battery LED Display: The bluetooth earphone in ear of the new model has a Battery LED display function .By touching the button you can easily read the power of the box, without worrying about the power outage of the box. one-button operation, play pause, answer hang up, summon Siri, switch songs.</li>
                            <li>Waterproof & Ergonomical Design: waterproof level can easily resist sweat and water, and you don't have to worry even if it rains. Equipped with three different sizes of soft silicone ear tips (S, M, L), These sport headphones are very suitable for outdoor sports, workouts whole day, just enjoy yourself !</li>
                            <li>True Wireless Earbuds with Box : Mini box and easy to carry, true wireless connection and charging.Mini box can do mobile phone bracket (The box has a USB interface to your other devices urgently)</li>
                        </ul>
                    </div>
                    <div className="more-detail">
                    Please follow the above steps. If you have done it wrong  there is only one headset with sound.
                        <ul>
                            <li>First put the headset back into the headset case, if your phone has been connected to the headset before, delete the connected Bluetooth name</li>
                            <li>Take out two earphones at the same time, please give it time to pair  if the pairing is successful, only one earphone has light</li>
                            <li>After the two headsets are paired successfully, turn on the Bluetooth of the mobile phone to search</li>
                        </ul>
                    </div>
                    <div className="more-detail">
                                ...
                                <div className="features">
                                    ...
                                    <div className="markup">
                                        <ul>
                                            ...
                                            <li>3 pairs * Soft earplugs (Large, medium, Small)</li>
                                            <li>1 * manual </li>
                            ...
                            <div className="spec-detail">
                                <div className="spec-item">
                                    ...
                                    <div className="spec-list">
                                        <ul>
                                            <li><span>SKU</span>: AC431EA4CKAFQNAFAMZ</li>   
                                            <li><span>Product Line</span>: F9-8</li>  
                                            <li><span>Model</span>: F9</li>  
                                            <li><span>Production Country</span>: China</li>  
                                            <li><span>Size (L x W x H cm)</span>: 16*12*8</li>  
                                            <li><span>Weight(kg)</span>: 0.12</li>  
                                            <li><span>Certifications</span>: Eco Friendly</li>  
                                            <li><span>Color</span>: Black</li>  
                                            <li><span>Main Material</span>: ABS</li>  
                                            <li><span>From the Manufacturer</span>: y</li>  
                                            <li><span>Care Label</span>: y</li>  
