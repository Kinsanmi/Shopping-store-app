          ...
          <div className="portable-content">
                      ...
                      <div className="drink">
                        <div className="drink-can">
                          ...
                          <div className="product">
                            Brand: <Link>Fanta</Link> |{" "}
                            <Link>Similar products from Fanta</Link>
                          </div>
                        </div>
                      </div>
            ...
            <div id="/product/detail" className="portable-detail">
              ...
              <div className="detail">
                Fanta is an orange flavoured soft drink and a product of the
                Coca Cola Company that produces some of the world’s best known
                drinks providing refreshment and enjoyment to billions of people
                everywhere. Fanta stands out from the rest of the competition as
                it has stood the test of time for years and years, showing
                itself as one of the best soft drinks in the world. Fanta’s
                refreshing orange flavours bottled in a unique 50cl bottle is
                made with 100% natural flavours and contains caffeine,
                carbonated water, high fructose corn syrup, citric acid, and
                natural flavours for that amazingly refreshing taste. It is said
                to have originated after a trade embargo for Coca-Cola,
                ingredients were placed in 1940 making it the second oldest
                  ...
                  <div className="spec-detail">
                    <div className="spec-item">
                      ...
                      <div className="spec-list">
                        <ul>
                          <li>
                            <span>SKU</span>: FA941DB0PVND6NAFAMZ
                          </li>
                          <li>
