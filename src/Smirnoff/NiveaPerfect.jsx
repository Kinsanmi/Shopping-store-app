    ...
    <>
      <main className="clear-page">
        <div className="link_page">
          ...
          <span>
            Perfect & Radiant Luminous630 Anti Dark Marks Day Cream SPF50 - 40ml
            (Pack of 2)
          </span>
        </div>
          ...
          <div className="portable-content">
                  ...
                  <div key={index} className="port-context">
                    <div className="port-img">
                      <img
                        ...
                        alt="product_image_name-NIVEA-Perfect & Radiant Luminous630 Anti Dark Marks Day Cream SPF50 - 40ml (Pack of 2)-1"
                      />
                      ...
                      <div className="drink">
                        <div className="drink-can">
                          <div className="drink-text">
                            NIVEA Perfect & Radiant Luminous630 Anti Dark Marks
                            Cream
                          ...
                          <div className="product">
                            Brand: <Link>NIVEA</Link> |{" "}
                            <Link>Similar products from NIVEA</Link>
                          </div>
                        </div>
                      </div>
            ...
            <div id="/product/detail" className="portable-detail">
              ...
              <div className="detail">
                <strong>NIVEA Perfect & Radiant </strong>Luminous 630 Day Cream
                SPF50 - Pack of 2
                <div className="more-detail">
                  A BREAKTHROUGH INNOVATION, 10 YEARS IN THE MAKING. It took
                  NIVEA® scientists 10 years of meticulous research and the
                  screening of 50,000 ingredients, to find the highly effective
                  LUMINOUS630®
                </div>
                <div className="more-detail">
                  NIVEA Perfect & Radiant Luminous 630 Day Face Cream contains
                  the highly effective patented LUMINOUS630® and is enriched
                  with Hyaluron, Vitamin E and UVA/UVB filters. It acts on
                  existing pigmentation to visibly reduce dark marks and spots,
                  while the SPF50 helps to reduce the appearance of new dark
                  marks. Skin is moisturised, mattified and smooth.
                </div>
                <div className="more-detail">
                  How To Use:
                  <ul>
                    ...
                    <li>
                      For optimal results, use in combination with Perfect &
                      Radiant LUMINOUS630® ANTI DARK MARKS Serum.
                    </li>
                  </ul>
                </div>
                <div className="more-detail">
                  ...
                  <ul>
                    ...
                    <li>
                      Works in conjunction with skin's natural melanin
                      production to reduce the appearance of new dark marks and
                      spots
                    </li>
                    <li>Effective on all skin tones</li>
                    <li>
                      Dermatologically approved & suitable for all skin types
                      including sensitive skin.
                    </li>
                  </ul>
                </div>
                INGREDIENTS : Aqua, Homosalate, Butyl Methoxydibenzoylmethane,
                Ethylhexyl Salicylate, Ethylhexyl Triazone, Butylene Glycol
                Dicaprylate/Dicaprate, Alcohol Denat., Bis-Ethylhexyloxyphenol
                Methoxyphenyl Triazine, Dimethicone, Silica, Phenylbenzimidazole
                Sulfonic Acid, Tapioca Starch, Cetearyl Alcohol, Behenyl
                Alcohol, Methylpropanediol, Glycerin, Isobutylamido Thiazolyl
                Resorcinol, Sodium Hyaluronate, Tocopheryl Acetate, Sodium
                Stearoyl Glutamate, Ethylhexylglycerin, Xanthan Gum, Sodium
                Chloride, Carbomer, Sodium Sulfate, Trisodium EDTA,
                    ...
                    <div className="features">
                      ...
                      <div className="markup">
                        <ul>
                          ...
                          <li>Patented LUMINOUS630®</li>
                          <li>
                            Acts on existing pigmentation to visibly reduce dark
                            marks and spots
                          </li>
                          <li>
                            Works in conjunction with skin's natural melanin
                            production to reduce the appearance of new dark
                            marks and spots
                          </li>
                          <li>Effective on all skin tones</li>
                          <li>
                            Dermatologically approved & suitable for all skin
                  ...
                  <div className="spec-features">
                    <div className="features">
                      ...
                      <div className="markup">
                        <ul>
                          <li>
                            NIVEA Perfect & Radiant Luminous 630 Day Cream SPF50
                            - 40ml - Pack of 2
                          </li>
                        </ul>
                      </div>
                  ...
                  <div className="spec-detail">
                    <div className="spec-item">
                      ...
                      <div className="spec-list">
                        <ul>
                          <li>
                            <span>SKU</span>: NI930ST4EGU5HNAFAMZ
                          </li>
                          <li>
                            <span>Weight(kg)</span>: 0.1
                          </li>
                          <li>
                            <span>Shop Type</span>: E-shop
                          </li>
                        </ul>
                      </div>
                    </div>
