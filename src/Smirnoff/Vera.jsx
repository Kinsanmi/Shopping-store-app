  ...
  return (
    ...
    <main className="clear-page">
        ...
        <Link to='/store'>Home<MdOutlineKeyboardArrowRight /></Link>
            ...
            <Link to='/store'>Fragrances<MdOutlineKeyboardArrowRight /></Link>
            <Link to='/store'>Women's<MdOutlineKeyboardArrowRight /></Link> <span>For WOmen EDP 100ml</span>
        </div>
        ...
        <div className="portable">
            <div className="portable-content">
                <div className="portable-img">
                    {VeraWang.map((item, index)=>{
                        ...
                        <div className="port-img">
                            <img src={item.image} alt="product_image_name-Vera Wang-For Women EDP 100ml-1" />
                        ...
                        <div className="port-desc">
                            <div className="drink">
                                <div className="drink-can">
                                    <div className="drink-text">Vera Wang For Women EDP 100ml<span className="heart"><FaRegHeart className='heart-icon' /></span></div>
                                    <div className="product">Brand: <Link>Vera Wang</Link> | <Link>Similar products from Vera Wang</Link></div>
                                </div>
                            </div>
                ...
                <div id='/product/detail' className="portable-detail">
                    ...
                    This supremely feminine fragrance was launched in 2002. Vera Wang for Women embodies a sultry, elegant aura unmatched by the average woman. The blend opens gracefully with top notes of cleaver and mandarin blossom. Deeply floral heart notes of gardenia and Bulgarian rose leave a strong impression while swirling with intoxicating base notes of pure musk and Stephanotis. This fragrance is recommended for daytime wear.
                    </div>
                </div>
                            ...
                            <div className="spec-detail">
                                <div className="spec-item">
                                    ...
                                    <div className="spec-list">
                                        <ul>
                                            <li><span>SKU</span>: VE887PF06OESFNAFAMZ</li>   
                                            <li><span>Product Line</span>: Earnbizzy Perfumery</li>  
                                        ...
                                        <article className='door-delivery'>
                                            ...
                                            <div className='door-detail'>
                                                ...
                                                <div className='delivery-amount'>
                                                    ...
                                                    <div className='amt-ready'>Ready for delivery between <span>05 January</span> & <span>06 January</span> when you order within <span>5hrs 12mins</span></div>
                                                </div>
                                            </div>
                                        </article>
                                    </div>
                                        ...
                                        <article className='door-delivery'>
                                            ...
                                            <div className='door-detail'>
                                                ...
                                                <div className='delivery-amount'>
                                                    ...
                                                    <div className='amt-ready'>Arriving at pickup station between  <span>05 January</span> & <span>06 January</span> when you order within <span>5hrs 12mins</span></div>
                                                </div>
                                            </div>
                                        </article>
                                    </div>
                    ...
                    <div className="sell-info">
                        <div className="delivery-text">
                            ...
                            <div className="sell-order">
                                <h4> <IoIosCheckmarkCircle className='mark' />Order fulfillment rate: <span>Average</span></h4>
                            </div>
                            <div className="sell-order">
