    ...
    <>
      <main className="clear-page">
        <div className="link_page">
          ...
          <span>
            Power Bank 20000 MAh Ultra Slim Portable Fast Charger (ACE ELEC)
          </span>
        </div>
          ...
          <div className="portable-content">
                      ...
                      <div className="drink">
                        <div className="drink-can">
                          <div className="drink-text">
                            Ace Elec Power Banks 20000 MAh Utra Slim Portable
                            Fast Charger (ACE ELEC)
                          ...
                          <div className="product">
                            ...
                            <Link>Similar products from Malta Ace Elec</Link>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="shipping">
                        ...
                        <div className="rating-star">
                          <div className="rating">
                            ...
                            <IoMdStar />
                            <IoMdStar />
                            <IoMdStar className="star-rating" />
                          </div>
                          <Link className="verify">
                            (5722 verified ratings)
                          </Link>
                        </div>
                      </div>
            ...
            <div id="/product/detail" className="portable-detail">
              ...
              <div className="detail">
                <strong>Floveme Power-Bank</strong>, PowerCore Slim 20000, Ultra
                Slim Portable Charger, Compact 20000mAh External Battery,
                High-Speed PowerIQ Charging Technology for Mobile phones, ipad,
                and more The New Generation Power-Bank P2W (20000mAh) is light,
                convenient and portable.{" "}
                <div className="more-detail">
                  The dual USB output ports support multiple charging protocols,
                  making it a partner in your travels that won't let you down.
                  The Power-Bank P2W (20000mAh) can charge at up to 18W (12V,
                  1.5A/9V, 2.0A), cutting back significantly on charging time.
                  Order for this Power-Bank P2W, 20000mAh online from Jumia
                  Nigeria and have it delivered to you.
                </div>
                <div className="more-detail">
                  <strong>Descriptions:</strong>
                  <ul>
                    <li>
                      Super good service：we use only the highest-grade
                      materials, so we do have the confidence to provide
                      industry-leading 3 years warranty.
                    </li>
                    <li>
                      High-speed Charging：Outpace your mates and charge 1.4x
                      faster through our exclusive UPower+ technology. Support
                      charging and discharging simultaneously.
                    </li>
                    <li>
                      Ultra Slim：Fashionable appearance outlook design, ultra
                      slim body. The thinnest 20000mAh power-bank on the market,
                      easily slips it into any of your pockets or bags. Built-in
                      multiple protections.
                    </li>
                    <li>
                      Versatile Charging: Power-Bank P2W exclusive PowerIQ and
                      VoltageBoost technology combine to deliver the fastest
                      possible charge for any device, while the trickle-charging
                      mode is the best way to charge low-power devices.
                    </li>
                    <li>
                      Certified Safe: MultiProtect is Power-Bank P2W safety
                      system, providing superior protection for you and your
                      devices.
                    </li>
                    <li>
                      Handy Flashlight: Simply click the power button twice to
                      turn on/off it. Helpful for reading camping blackout or
                      emergency.
                    </li>
                  </ul>
                </div>
                  ...
                  <div className="spec-detail">
                    <div className="spec-item">
                      ...
                      <div className="spec-list">
                        <ul>
                          <li>
                            <span>SKU</span>: FL585EA3CG6JHNAFAMZ
                          </li>
                          <li>
                            <span>Product Line</span>: Zeemak Ltd - AC
                          </li>
                          <li>
                            <span>Model</span>: 20000mah (ACE ELEC)
                          </li>
                          <li>
                            <span>Weight(kg)</span>: 0.2
                          </li>
                          <li>
                            <span>Color</span>: Black
                          </li>
                          <li>
                            <span>Shop Type</span>: Jumia Mall
                          </li>
                        </ul>
                      </div>
                    </div>
                          ...
                          <div className="door-detail">
                            ...
                            <div className="delivery-amount">
                              ...
                              <div className="amt-ready">
                                ...
                                <span>04 January</span> when you order within{" "}
                                <span>14hrs 43mins</span>
                              </div>
                            </div>
                          </div>
                        </article>
            ...
            <div className="row_footer">
              ...
              <div className="col_1">
                <div className="col-flex">
                  ...
                  <div className="app">
                    <div className="app-text">DOWNLOAD JUMIA FREE APP</div>
