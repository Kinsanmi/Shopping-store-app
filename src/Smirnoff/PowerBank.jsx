...
import { PowerBankAce, PowerImg } from '../Data/Products/Product';
...
export const PowerBank = ({handleAddProduct, to,label ,notificationMessage}) => {
    ...
    const [sliderData, setSliderData] = useState(PowerImg[0])

    const handleImage = (index)=>{
        const slider = PowerImg[index]
  ...
  return (
    ...
    <main className="clear-page">
        ...
        <Link to='/store'>Home<MdOutlineKeyboardArrowRight /></Link>
            ...
            <Link to='/store'>Mobile Phone Accessories<MdOutlineKeyboardArrowRight /></Link>
            <Link to='/store'>Batteries & Battery Packs<MdOutlineKeyboardArrowRight /></Link>
            <Link to='/store'>Portable Power Banks<MdOutlineKeyboardArrowRight /></Link> <span>Power Bank 20000 MAh Ultra Slim Portable Fast Charger (ACE ELEC)</span>
        </div>

        <div className="portable">
            <div className="portable-content">
                <div className="portable-img">
                    {PowerBankAce.map((item, index)=>{
                        return (
                        ...
                        <div className="port-desc">
                            <div className="drink">
                                <div className="drink-can">
                                    <div className="drink-text">Ace Elec Power Banks 20000 MAh Utra Slim Portable Fast Charger (ACE ELEC)<span className="heart"><FaRegHeart className='heart-icon' /></span></div>
                                    <div className="product">Brand: <Link>Ace Elec</Link> | <Link>Similar products from Malta Ace Elec</Link></div>
                                </div>
                            </div>
                            ...
                            <div className="flash-sales">
                                ...
                                <div className="sales-amount">
                                    ...
                                    <div className="progress-icon">
                                        <div className="sales-item">316 items left</div>
                                        <div className="progress-bar-power"></div>
                                    </div>
                            ...
                            <div className="shipping">
                                ...
                                <div className="rating-star">
                                    ...
                                    <IoMdStar /><IoMdStar /><IoMdStar /><IoMdStar /><IoMdStar className='star-rating' />
                                    </div>
                                    <Link className='verify'>(5722 verified ratings)</Link>
                                </div>
                            </div>
                ...
                <div id='/product/detail' className="portable-detail">
                    ...
                    <div className="detail"><strong>Floveme Power-Bank</strong>, PowerCore Slim 20000, Ultra Slim Portable Charger, Compact 20000mAh External Battery, High-Speed PowerIQ Charging Technology for Mobile phones, ipad, and more The New Generation Power-Bank P2W (20000mAh) is light, convenient and portable. <div className="more-detail">
                    ...
                    <div className="more-detail">
                        ...
                        <ul>
                            <li>Super good service：we use only the highest-grade materials, so we do have the confidence to provide industry-leading 3 years warranty.</li>
                            <li>High-speed Charging：Outpace your mates and charge 1.4x faster through our exclusive UPower+ technology. Support charging and discharging simultaneously.</li>
                            <li>Ultra Slim：Fashionable appearance outlook design, ultra slim body. The thinnest 20000mAh power-bank on the market, easily slips it into any of your pockets or bags. Built-in multiple protections.</li>
                            <li>Versatile Charging: Power-Bank P2W exclusive PowerIQ and VoltageBoost technology combine to deliver the fastest possible charge for any device, while the trickle-charging mode is the best way to charge low-power devices.</li>
                            <li>Certified Safe: MultiProtect is Power-Bank P2W safety system, providing superior protection for you and your devices.</li>
                            <li>Handy Flashlight: Simply click the power button twice to turn on/off it. Helpful for reading camping blackout or emergency.</li>
                        </ul>
                    </div>
                    ...
                    <div className="more-detail">
                        ...
                        <ul>
                            <li>Brand: Floveme</li>
                            <li>Model: P2W</li>
                            <li>Material: Fireproof  ABS+PC</li>
                            <li>Capacity: 20000mAh </li>
                            <li>Input interface: Micro USB 5V 2.1A</li>
                            <li>Output USB: 2 USB (USB-A) 5V 2.1A</li>
                            <li>Dimensions: 135 * 65 * 25mm</li>
                    ...
                    <div className="more-detail">
                        ...
                        <ul>
                            <li> Battery Type: Lithium polymer batteries</li>
                            <li>Input: 5.0V 2.1A</li>
                            <li>Output: 5.1V 2.1A </li>
                            <li>Unique Tech: Quick Charge 3.0 </li>
                        </ul>
                    </div>
                        ...
                        <div className="spec-info">
                            ...
                            <div className="spec-detail">
                                <div className="spec-item">
                                    ...
                                    <div className="spec-list">
                                        <ul>
                                            <li>1 * Dual USB 20000mAh Power</li>   
                                            <li>Bank1*charge cable</li>  
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="spec-detail">
                                <div className="spec-item">
                                    ...
                                    <div className="spec-list">
                                        <ul>
                                            <li><span>SKU</span>: FL585EA3CG6JHNAFAMZ</li>   
                                            <li><span>Product Line</span>: Zeemak Ltd - AC</li>  
                                            <li><span>Model</span>: 20000mah (ACE ELEC)</li>  
                                            <li><span>Weight(kg)</span>: 0.2</li>  
                                        ...
                                        <article className='door-delivery'>
                                            ...
                                            <div className='door-detail'>
                                                ...
                                                <div className='delivery-amount'>
                                                    ...
                                                    <div className='amt-ready'>Ready for delivery between <span>02 January</span> & <span>04 January</span> when you order within <span>14hrs 43mins</span></div>
                                                </div>
                                            </div>
                                        </article>
                                    </div>
                                        ...
                                        <article className='door-delivery'>
                                            ...
                                            <div className='door-detail'>
                                                ...
                                                <div className='delivery-amount'>
                                                    ...
                                                    <div className='amt-ready'>Arriving at pickup station between  <span>02 January</span> & <span>04 January</span> when you order within <span>14hrs 1.4x3mins</span></div>
                                                </div>
                                            </div>
                                        </article>
                                    </div>
