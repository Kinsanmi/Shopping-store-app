...
export const Adidas = ({handleAddProduct, to,label ,notificationMessage}) => {
  ...
  return (
    ...
    <main className="clear-page">
        ...
        <Link to='/store'>Home<MdOutlineKeyboardArrowRight /></Link>
            ...
            <Link to='/store'>Shoes<MdOutlineKeyboardArrowRight /></Link> <span>Advantage Lifestyle Court Lace Shoes</span>
        </div>
        ...
        <div className="portable">
            <div className="portable-content">
                <div className="portable-img">
                    {AdidasLace.map((item, index)=>{
                        ...
                        <div className="port-img">
                            <img src={sliderData.value} alt="product_image_name-ADIDAS-Advantage Lifestyle Court Lace Shoes-1" />

                            <div className="port-image">
                                {AdidasImg.map((item, i)=>{
                                    return (
                                        <img className={sliderData.id===i ? 'border' : ''} key={item.id} src={item.value} alt='product_image_name-ADIDAS-Advantage Lifestyle Court Lace Shoes-1' onClick={()=> handleImage(i)} />
                                    )
                                })}
                            </div>
                        ...
                        <div className="port-desc">
                            <div className="drink">
                                <div className="drink-can">
                                    <div className="drink-text">ADIDAS Advantage Lifestyle Court Lace Shoes<span className="heart"><FaRegHeart className='heart-icon' /></span></div>
                                    <div className="product">Brand: <Link>ADIDAS</Link> | <Link>Similar products from ADIDAS</Link></div>
                                </div>
                            </div>
                            ...
                            <div className="flash-sales-item">
                                ...
                                <div className="sales-amount">
                                    ...
                                    <div className="progress-icon">
                                        <div className="sales-item">some variations with low stock</div>
                            ...
                            <span className="size-adidas">EU 30.5</span>
                            <span className="size-adidas">EU 31</span>
                ...
                <div id='/product/detail' className="portable-detail">
                    ...
                    <div className="detail">These kids' adidas lace-up sneakers are great for school, sports clubs and all the play that kids fit in between. They're made with a smooth, synthetic upper for a comfortable feel. A sturdy rubber outsole offers dependable traction.
                            ...
                            <div className="spec-detail">
                                <div className="spec-item">
                                    ...
                                    <div className="spec-list">
                                        <ul>
                                            <li><span>SKU</span>: AD002FS2M051TNAFAMZ</li>   
                                            <li><span>Product Line</span>: adidas Official Store</li>  
                                            <li><span>Model</span>: GW6484</li>  
                                            <li><span>Weight(kg)</span>: 0.8</li>  
                                        ...
                                        <article className='door-delivery'>
                                            ...
                                            <div className='door-detail'>
                                                ...
                                                <div className='delivery-amount'>
                                                    ...
                                                    <div className='amt-ready'>Ready for delivery between <span>02 January</span> & <span>03 January</span> when you order within <span>4hrs 23mins</span></div>
                                                </div>
                                            </div>
                                        </article>
                                    </div>
                                        ...
                                        <article className='door-delivery'>
                                            ...
                                            <div className='door-detail'>
                                                ...
                                                <div className='delivery-amount'>
                                                    ...
                                                    <div className='amt-ready'>Arriving at pickup station between  <span>02 January</span> & <span>03 January</span> when you order within <span>4hrs 23mins</span></div>
                                                </div>
                                            </div>
                                        </article>
                                    </div>
                    ...
                    <div className="sell-info">
                        <div className="delivery-text">
                            ...
                            <div className="free-delivery">
                                ...
                                <h4><span>2381</span> Followers</h4>
                            </div>
                            ...
                            <div className="sell-order">
                                <h4> <MdStars className='star-rate' />Customer Rating: <span>Excellent</span></h4>
                            </div>
                        </div>
                    </div>
