    ...
    <>
      <main className="clear-page">
        <div className="link_page">
          ...
          <span>
            Kids Leather Martin Boots Girls Boys Sneaker Shoes - Brown
          </span>
        </div>
          ...
          <div className="portable-content">
                  ...
                  <div key={index} className="port-context">
                    <div className="port-img">
                      <img
                        ...
                        alt="product_image_name-Fashion-Kids Leather Martin Boots Girls Boys Sneaker Shoes - Brown-1"
                      />
                      ...
                      <div className="drink">
                        <div className="drink-can">
                          <div className="drink-text">
                            Kids Leather Martin Boots Girls Boys Sneaker Shoes -
                            Brown
            ...
            <div id="/product/detail" className="portable-detail">
              ...
              <div className="detail">
                For more products, please click on the pictures!
                <div className="more-detail">
                  ...
                  Providing children with <strong>comfortable</strong> and{" "}
                  <strong>fashionable</strong> shoes is our store's philosophy.
                  Side zipper design, easy to put on and take off, fit the
                  baby's foot to a great extent and improve comfort. Non-slip
                  textured sole. The inside does not grind the feet, and the
                  upper feet are soft. The shoe compartment mesh wraps the soles
                  of the feet lightly and softly, absorbs the sweat of the feet,
                  is breathable, and is dry and comfortable without resting on
                  the feet. The anti-collision toe cap protects the baby's toes
                  well. Textured leather upper, preferably comfortable and
                  breathable high-quality soft fabrics, soft texture, versatile
                  ...
                  <div className="spec-detail">
                    <div className="spec-item">
                      ...
                      <div className="spec-list">
                        <ul>
                          <li>
                            <span>SKU</span>: FA203FS2IGBRONAFAMZ
                          </li>
                          <li>
                            <span>Model</span>: BSS022
                          </li>
                          <li>
                          ...
                          <li>
                            <span>Main Material</span>: Rubber
                          </li>
                          <li>
                            <span>Shop Type</span>: Jumia Mall/Food
                          </li>
                        </ul>
                      </div>
                    </div>
