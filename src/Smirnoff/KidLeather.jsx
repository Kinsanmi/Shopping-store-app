...
import { KidImg, KidLeather1, MaltaGuinness, MaltaImg } from '../Data/Products/Product';
...
import max from '../Data/Image Product/20231018155927.jpg';
import max1 from '../Data/Image Product/20231018155947.jpg';
import max2 from '../Data/Image Product/20231018160032.jpg';



export const KidLeather = ({handleAddProduct, to,label ,notificationMessage}) => {
    ...
    const Timer = ()=>{
        const nextDay = new Date('December 29, 2023, 10:00:48').getTime();
    ...
    const [sliderData, setSliderData] = useState(KidImg[0])

    const handleImage = (index)=>{
        const slider = KidImg[index]
  ...
  return (
    ...
    <main className="clear-page">
        ...
        <Link to='/store'>Home<MdOutlineKeyboardArrowRight /></Link>
            ...
            <Link to='/store'>Kid's Fashion<MdOutlineKeyboardArrowRight /></Link>
            <Link to='/store'>Boys<MdOutlineKeyboardArrowRight /></Link>
            <Link to='/store'>Shoes<MdOutlineKeyboardArrowRight /></Link> <span>Kids Leather Martin Boots Girls Boys Sneaker Shoes - Brown</span>
        </div>

        <div className="portable">
            <div className="portable-content">
                <div className="portable-img">
                    {KidLeather1.map((item, index)=>{
                        return (
                        <div key={index} className="port-context">
                        <div className="port-img">
                            <img src={sliderData.value} alt="product_image_name-Fashion-Kids Leather Martin Boots Girls Boys Sneaker Shoes - Brown-1" />

                            <div className="port-image">
                                {KidImg.map((item, i)=>{
                                    return (
                                        <img className={sliderData.id===i ? 'border' : ''} key={item.id} src={item.value} alt='product_image_name-Fashion-Kids Leather Martin Boots Girls Boys Sneaker Shoes - Brown-1' onClick={()=> handleImage(i)} />
                                    )
                                })}
                            </div>
                        ...
                        <div className="port-desc">
                            <div className="drink">
                                <div className="drink-can">
                                    <div className="drink-text">Kids Leather Martin Boots Girls Boys Sneaker Shoes - Brown<span className="heart"><FaRegHeart className='heart-icon' /></span></div>
                            ...
                            <div className="flash-sales">
                                ...
                                <div className="sales-amount">
                                    ...
                                    <div className="progress-icon">
                                        <div className="sales-item">1 items left</div>
                                        <div className="progress-bar-kid"></div>
                                    </div>
                            ...
                            <div className="shipping">
                                ...
                                <div className="rating-star">
                                    ...
                                    <Link className='verify'>(2 verified ratings)</Link>
                                </div>
                            </div>
                ...
                <div id='/product/detail' className="portable-detail">
                    ...
                    <div className="detail">For more products, please click on the pictures!<div className="more-detail">
                    <div className="kid-img">
                        <img src={max} alt="product_image_name-Fashion-Kids Leather Martin Boots Girls Boys Sneaker Shoes - Brown-1" />
                        <img src={max1} alt="product_image_name-Fashion-Kids Leather Martin Boots Girls Boys Sneaker Shoes - Brown-1" />
                        <img src={max2} alt="product_image_name-Fashion-Kids Leather Martin Boots Girls Boys Sneaker Shoes - Brown-1" />
                    </div>
                    Providing children with <strong>comfortable</strong> and <strong>fashionable</strong> shoes is our store's philosophy. Side zipper design, easy to put on and take off, fit the baby's foot to a great extent and improve comfort. Non-slip textured sole. The inside does not grind the feet, and the upper feet are soft. The shoe compartment mesh wraps the soles of the feet lightly and softly, absorbs the sweat of the feet, is breathable, and is dry and comfortable without resting on the feet. The anti-collision toe cap protects the baby's toes well. Textured leather upper, preferably comfortable and breathable high-quality soft fabrics, soft texture, versatile colors, elegant without losing temperament, quite textured. Elastic nylon laces with bronzed metal grommets.
                    </div>
                        ...
                        <div className="spec-info">
                                ...
                                <div className="features">
                                    ...
                                    <div className="markup">
                                        <ul>
                                            <li>Brown color</li>
                                            <li>Size: 21-30</li>
                                            <li>Upper material: microfiber leather</li>
                                            <li>Sole Material: Rubber</li>
                                            <li>Side zipper for easy on and off</li>
                                            <li>Non-slip and wear-resistant sole</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="spec-detail">
                                <div className="spec-item">
                                    ...
                                    <div className="spec-list">
                                        <ul>
                                            <li>1*Martin Children's Boots </li>   
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div className="spec-detail">
                                <div className="spec-item">
                                    ...
                                    <div className="spec-list">
                                        <ul>
                                            <li><span>SKU</span>: FA203FS2IGBRONAFAMZ</li>   
                                            <li><span>Model</span>: BSS022</li>  
                                            <li><span>Weight(kg)</span>: 0.3</li>  
                                            <li><span>Color</span>: Brown</li>  
                                            <li><span>Main Material</span>: Rubber</li>  
                ...
                <div className="delivery-content">
                                        ...
                                        <article className='door-delivery'>
                                            ...
                                            <div className='door-detail'>
                                                ...
                                                <div className='delivery-amount'>
                                                    ...
                                                    <div className='amt-ready'>Ready for delivery between <span>30 January</span> & <span>01 January</span> when you order within <span>4hrs 7mins</span></div>
                                                </div>
                                            </div>
                                        </article>
                                    </div>
                                        ...
                                        <article className='door-delivery'>
                                            ...
                                            <div className='door-detail'>
                                                ...
                                                <div className='delivery-amount'>
                                                    ...
                                                    <div className='amt-ready'>Arriving at pickup station between  <span>30 January</span> & <span>01 January</span> when you order within <span>4hrs 7mins</span></div>
                                                </div>
                                            </div>
                                        </article>
                                    </div>
                    ...
                    <div className="sell-info">
                        <div className="delivery-text">
                            ...
                            <div className="free-delivery">
                                <h3>aidailuglobal2019-COD</h3>
                                <h4><span>80%</span> seller Score</h4>
                                <h4><span>100</span> Followers</h4>
                            </div>
