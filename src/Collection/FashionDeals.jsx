...
export const FashionDeals = ({product_Item,handleAddProduct,notificationMessage}) => {
  return (
    <>
    <main className="clear-page">
        <div className="link_page">
            <Link to='/store'>Home<MdOutlineKeyboardArrowRight /></Link> <span>Fashion</span>
        </div>

        <div className="home-text">
            <div className="home-appliance">Fashion</div>
        </div>
